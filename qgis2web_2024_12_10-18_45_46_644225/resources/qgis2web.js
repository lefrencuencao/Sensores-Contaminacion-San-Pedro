...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 19, minZoom: 8, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-100.418062, 25.618974, -100.308167, 25.689286], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Sensorescontaminacin_7,
    colName: 'CV_PUNTO',
    zoom: 10,
    collapsed: true,
    map: map
